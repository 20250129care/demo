...
class UserBulkUpdateRestControllerConverterTest {
    ...
    class Method1 {
        ...
        void testOK1() {
            ...
            UserBulkUpdateParam bulkParam = converter.convertToParam(bulkRequest);

            // -----------------------------------------------------------------
            // 実行結果確認
            // -----------------------------------------------------------------

            List<UserUpdateParam> paramList = bulkParam.getList();
            assertThat(paramList).hasSize(3);
            UserUpdateParam param1 = paramList.get(0);
            assertThat(param1.getId()).isEqualTo(BASE_ID + "_01");
            assertThat(param1.getFamilyName()).isEqualTo(BASE_FAMILY_NAME + "101");
            assertThat(param1.getFirstName()).isEqualTo(BASE_FIRST_NAME + "101");
            assertThat(param1.getDeptId()).isEqualTo(DEPT_ID);
            assertThat(param1.getVersion()).isEqualTo(VERSION);
            UserUpdateParam param2 = paramList.get(1);
            assertThat(param2.getId()).isEqualTo(BASE_ID + "_02");
            assertThat(param2.getFamilyName()).isEqualTo(BASE_FAMILY_NAME + "102");
            assertThat(param2.getFirstName()).isEqualTo(BASE_FIRST_NAME + "102");
            assertThat(param2.getDeptId()).isEqualTo(DEPT_ID);
            assertThat(param2.getVersion()).isEqualTo(VERSION);
            UserUpdateParam param3 = paramList.get(2);
            assertThat(param3.getId()).isEqualTo(BASE_ID + "_03");
            assertThat(param3.getFamilyName()).isEqualTo(BASE_FAMILY_NAME + "103");
            assertThat(param3.getFirstName()).isEqualTo(BASE_FIRST_NAME + "103");
            assertThat(param3.getDeptId()).isEqualTo(DEPT_ID);
            assertThat(param3.getVersion()).isEqualTo(VERSION);
        }
