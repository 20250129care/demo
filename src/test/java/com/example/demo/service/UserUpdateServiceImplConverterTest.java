...
class UserUpdateServiceImplConverterTest {
    ...
    class Method1 {
        ...
        void testOK1() {
            ...
            assertThat(entity.getFamilyName()).isEqualTo(BASE_FAMILY_NAME + "101");
            assertThat(entity.getFirstName()).isEqualTo(BASE_FIRST_NAME + "101");
